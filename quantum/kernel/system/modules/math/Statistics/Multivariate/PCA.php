...
namespace Quantum\Math\Statistics\Multivariate;

use Quantum\Math\Exception;
use Quantum\Math\Functions\Map\Single;
use Quantum\Math\LinearAlgebra\Eigenvalue;
use Quantum\Math\LinearAlgebra\Matrix;
use Quantum\Math\LinearAlgebra\MatrixFactory;
use Quantum\Math\LinearAlgebra\Vector;
use Quantum\Math\Probability\Distribution\Continuous\F;
use Quantum\Math\Probability\Distribution\Continuous\StandardNormal;
use Quantum\Math\Statistics\Descriptive;
