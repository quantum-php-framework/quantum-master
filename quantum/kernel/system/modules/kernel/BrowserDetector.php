 ...
 * This file contains everything required to use the BrowserDetector class.
 *
...
/**
 * The BrowserDetector class facilitates the identification of the user's environment such as Web browser, version,
 * platform or if it's a mobile device.
 *
 * Typical usage:
 *
 * $browser = new BrowserDetector();
 * if ($browser->getName() == BrowserDetector::BROWSER_FIREFOX &&
...
class BrowserDetector extends Singleton
{
    ...
    const BROWSER_UNKNOWN = 'Undetected Browser';
    ...
    const PLATFORM_UNKNOWN = 'Undetected Platform';
    const PLATFORM_VERSION_UNKNOWN = 'Undetected OS Version';
     ...
     */
    const VERSION_UNKNOWN = 'Unknown Version';
    ...
    /**
     * BrowserDetector class constructor.
     * @param QString $useragent (optional) The user agent to work with. Leave empty for the current user agent
     ...
     * @return QString Returns an HTML formatted string with a summary of the browser informations.
     */
     ...
     * @param QString $sourceVer The source version number.
     * @param QString $compareVer The version number to compare with the source version number.
     ...
     * @return QString Returns the version of AOL or an empty string if no AOL version was found.
     */
     ...
     * $myBrowserInstance->getName() == BrowserDetector::BROWSER_FIREFOX.
     * @return QString Returns the name of the browser.
     */
     ...
     * $myBrowserInstance->getPlatform() == BrowserDetector::PLATFORM_ANDROID.
     * @return QString Returns the name of the platform or BrowserDetector::PLATFORM_UNKNOWN if unknown.
     */
     ...
     * @return QString Returns the version name/version numbers of the platform or the constant PLATFORM_VERSION_UNKNOWN
     * if unknown.
     */
     ...
     * @return QString Returns the version of the browser or BrowserDetector::VERSION_UNKNOWN if unknown.
     */
    ...
    {
        return $this->_browserName." ".$this->_version;
    }

    public function getReadableName()
    {
        return $this->getName()." ".$this->getVersion()." (".$this->getPlatform(). " - ".$this->getPlatformVersion().")";
    }
     ...
     * @param QString $agentString (optional) The value of the user agent. If an empty string is sent (default),
     ...
     * @access protected
     * @param QString $androidVer The Android version numbers as a string.
     * @return QString The operating system name or the constant PLATFORM_VERSION_UNKNOWN if nothing match the version
     * numbers.
     */
     ...
     * agent.
     * @param QString $userAgent The user agent string to work with.
     * @param QString $browserName The literal browser name. Always use a class constant!
     ...
     * @param boolean $isMobile (optional) Determines if the browser is from a mobile device.
     * @param boolean $isRobot (optional) Determines if the browser is a robot or not.
     * @param QString $separator (optional) The separator string used to split the browser name and the version number in
     * the user agent.
     * @return boolean Returns true if we found the browser we were looking for, false otherwise.
     */
     ...
     * @param QString $haystack The string to search in.
     ...
     * @access protected
     * @param QString $version The version string to clean.
     * @return QString Returns the cleaned version number string.
     */
     ...
     * @access protected
     * @param QString $macVer The macOS version numbers as a string.
     * @return QString The operating system name or the constant PLATFORM_VERSION_UNKNOWN if nothing match the version
     * numbers.
     */
     ...
     * @access protected
     * @param QString $intStr The scalar value being converted to an integer.
     ...
     * @access protected
     * @param QString $version A string representing the version number.
     * @link http://web.archive.org/web/20080514173941/http://developer.apple.com/internet/safari/uamatrix.html
     * @return QString Returns the Safari version string. If the version can't be determined, an empty string is
     * returned.
     */
     ...
     * @access protected
     * @param QString $version The version of AOL (will be cleaned).
     */
     ...
     * @access protected
     * @param QString $browserName The name of the browser.
     */
     ...
     * @access protected
     * @param QString $platform The name of the platform.
     */
     ...
     * @access protected
     * @param QString $platformVer The version numbers of the platform.
     */
     ...
     * @access protected
     * @param QString $version The version of the browser.
     */
     ...
     * 'Windows XP'.
     * @access protected
     * @param QString $winVer The Windows NT family version numbers as a string.
     * @param boolean $returnServerFlavor (optional) Since some Windows NT versions have the same values, this flag
     * determines if the Server flavor is returned or not. For instance Windows 8.1 and Windows Server 2012 R2 both use
     * version 6.3.
     * @return QString The operating system name or the constant PLATFORM_VERSION_UNKNOWN if nothing match the version
     ...
     * returns 'Windows 98'.
     * @access protected
     * @param QString $winVer The Windows 3.x or 9x family version numbers as a string.
     * @return QString The operating system name or the constant PLATFORM_VERSION_UNKNOWN if nothing match the version
     * numbers.
     */
