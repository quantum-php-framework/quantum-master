...
class Model
{
	 ...
	 *
	 * <ul>
	 * <li><b>set:</b> QString/hash of field names and their values to be updated with
	 * <li><b>conditions:</b> Conditions using a string/hash/array</li>
	...
	public function set_timestamps()
	{
        ...
        if (isset($this->uuid) && $this->is_new_record())
            $this->uuid = Utils::gen_uuid();
	...
	{
		return \Quantum\HashId::encode($this->id);
	}
