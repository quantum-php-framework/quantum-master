            ...
            <div class="hero-inner text-center">
                <div class="bg-white">
                    <div class="content content-full overflow-hidden">
                        <div class="py-4">
                            <!-- Error Header -->
                            <h1 class="display-1 font-w600 text-city">500</h1>
                            <h2 class="h4 font-w400 text-muted mb-5">Server Error..</h2>
                            <!-- END Error Header -->
                ...
                <div class="content content-full text-muted">
                    ...
                    <a class="link-fx" href="javascript:void(0)">Report it</a> or <a class="link-fx" href="/">Go Back to Dashboard</a>
                    <!-- END Error Footer -->
                </div>
            </div>
        </div>
